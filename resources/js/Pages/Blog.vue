...
<div class="md:hidden flex">
 <p class="text-sm  sm:text-base md:text-xl mb-5 sm:mb-6 leading-relaxed max-w-2xl">
   Welcome to our blog, a place for creative ideas and practical inspiration. Explore insightful posts, useful tips, and stories that encourage learning and growth. We invite you to discover, get inspired, and enjoy being part of our creative community.
  </p>
</div>
...
<div class="w-full flex justify-start items-center px-5 md:px-10 mb-20 gap-10 flex-wrap ">

<div
   v-for="blog in props.posts.data"
  :key="blog.id"
 class="rounded-lg w-full md:w-[350px] shadow-lg shadow-gray-400 overflow-hidden hover:shadow-xl transition duration-300">
